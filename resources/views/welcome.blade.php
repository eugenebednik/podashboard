                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul>
                            ...
                            <li>Set up a separate role on your Discord server for users that will be ale to login to the Dashboard, such as <code>Protocol Officer</code> or <code>PO</code>.</li>
                            <li>Use the URL provided to you by the Discord bot to login.</li>
